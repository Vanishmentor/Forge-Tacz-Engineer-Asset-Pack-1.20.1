...
public class ItemCraftingToolWithDescription extends ItemCraftingTool {

    public String item_desc_id;

    public ItemCraftingToolWithDescription(Properties pProperties, String input_item_desc_id) {
        super(pProperties);
